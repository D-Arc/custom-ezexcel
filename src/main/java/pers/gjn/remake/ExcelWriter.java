 ...
 * mod: 使用修改过的CustomExcelBuilder(Impl)
 *
...
public class ExcelWriter {
    ...
    private CustomExcelBuilder excelBuilder;
    ...
    public ExcelWriter writerWidth(List<List<String>> data, Sheet sheet, Map<Integer, Integer> widthMap){
        excelBuilder.addContent(data, sheet, widthMap);
        return this;
    }
