...
public class GenerateContextImpl implements GenerateContext {
     ...
     * added
     */
    private CellStyle alertCellStyle;
    ...
    private void buildTableStyle(TableStyle tableStyle) {
        if (tableStyle != null) {
            ...
            CellStyle alertStyle = buildDefaultCellStyle();
            ...
            alertStyle.setFillForegroundColor(HSSFColor.YELLOW.index);
            this.alertCellStyle = alertStyle;
        }
    }
    ...
    public CellStyle getAlertCellStyle() {
        return alertCellStyle;
    }

    public void setAlertCellStyle(CellStyle alertCellStyle) {
        this.alertCellStyle = alertCellStyle;
    }
}
